...
from amazons.algorithms.minimax.minimax_algorithm import MinimaxAlgorithm, evaluate_mobility, sort_moves, weight
...
class MinimaxAlgorithmMobilityTable(MinimaxAlgorithm):
    """
    Class for the Minimax algorithm with mobility evaluation and history table
