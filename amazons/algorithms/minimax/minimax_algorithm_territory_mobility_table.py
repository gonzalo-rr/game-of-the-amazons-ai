...
from amazons.algorithms.minimax.minimax_algorithm import sort_moves, MinimaxAlgorithm, calculate_queen_boards, \
...
class MinimaxAlgorithmTerritoryMobilityTable(MinimaxAlgorithm):
    """
    Class for the Minimax algorithm with territory-mobility evaluation and hitory table
