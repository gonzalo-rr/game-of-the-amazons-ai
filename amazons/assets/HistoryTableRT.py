...
class HistoryTableRT:
    def __init__(self):
        if os.path.isfile('history_table_rt.pkl'):  # Load table if it exists
            self.load_table()
    ...
    def save_table(self):
        with open('history_table_rt.pkl', 'wb') as output:
            pickle.dump(self, output)

    def load_table(self):
        with open('history_table_rt.pkl', 'rb') as inp:
